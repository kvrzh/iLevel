...
class Operation extends \yii\db\ActiveRecord
{
    ...
    { // получение всех операций или операций за определенный период, подсчет суммы, получение даты первой и последней операции за промежуток
